...
#stop ${AMS_NAME} ${path}/ams/rpc 8601
#stop ${PMS_NAME} ${path}/pms/rpc 8602
#stop ${UMS_NAME} ${path}/ums/rpc 8603
#stop ${OMS_NAME} ${path}/oms/rpc 8604
stop ${RPC_NAME} ${path}/rpc_front 8652
